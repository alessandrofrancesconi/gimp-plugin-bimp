...
set libdir=C:\DevelopmentTools\libs\c
set gtk=gtk_bundle_2_16_6
set gimp=gimp_2_8_2_i686_dev
set pcre=pcre_7_0_lib

set mingwdir=C:\DevelopmentTools\mingw_bundle_0_6
...
pause
=======
>>>>>>> 65f46c8851473a940f844c0a24be99b3006c01b7
